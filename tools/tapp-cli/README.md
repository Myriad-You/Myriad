...
The examples pin `@myriad-you/tapp-cli` to `0.1.1`. Keep the version explicit in
...
```bash
npx --yes --package=@myriad-you/tapp-cli@0.1.1 myriad-tapp init ./my-tapp --type page
npx --yes --package=@myriad-you/tapp-cli@0.1.1 myriad-tapp check ./my-tapp --json
npx --yes --package=@myriad-you/tapp-cli@0.1.1 myriad-tapp pack ./my-tapp --json
```
...
```bash
npm install --save-dev --save-exact @myriad-you/tapp-cli@0.1.1
...
```bash
npm install --global @myriad-you/tapp-cli@0.1.1
```
