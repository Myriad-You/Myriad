            ...
            >
              ...
              <div className="flex items-center justify-between px-3 py-2 safe-area-inset-bottom">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <ChevronUp className={`w-5 h-5 transition-transform ${showMobileControls ? 'rotate-180' : ''}`} />
                  </button>
                </div>
              </div>
                    ...
                    <div className="px-3 py-3 space-y-3">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {isAuthenticated && (
                            <button
                              ...
                              title={hasComments ? `${t.brew.viewComments} (${comments.length})` : t.brew.selectTextToComment}
                            >
                          ...
                          {isBrewlia && (isAdmin || item.has_ai_annotations) && (
                            <button
                              ...
                              className={`p-2 rounded-xl ${
                                activePanel === 'annotations' || (showAnnotations && annotations.length > 0)
                                  ? 'text-purple-500 bg-purple-500/10'
                                  : `${currentTheme.secondary} hover:text-purple-500`
                              }`}
                              title={annotationsLoading ? `${t.brew.loading}...` : t.brew.aiAnnotations}
                            >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          title={(t.brew as Record<string, string>)[currentFont.labelKey]}
                        >
      ...
      <AnimatePresence>
        {activePanel && (
          ...
          >
            ...
            >
              {/* 面板头部 */}
              <div className={`flex items-center justify-between px-4 py-3 border-b ${currentTheme.border}`}>
                <div className="flex items-center gap-2">
                  {activePanel === 'toc' && (
                    <>
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      >
                        ...
                        {showAnnotations ? t.brew.hideHighlight : t.brew.showAnnotations}
                      </button>
                      {isAdmin && (
                        <button
                        ...
                        >
                          {annotationsLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : <RefreshCw className="w-4 h-4" />}
                          {t.brew.regenerate}
                        </button>
                      )}
                    </div>
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {cloudTtsLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : <Cloud className="w-4 h-4" />}
                          {t.brew.cloudTts}
                        </button>
                      </div>
                    </div>
                    ...
                    {podcastDialogues.length > 0 && (
                      <div className={`flex items-center justify-center gap-4 mb-4 p-3 rounded-xl ${isDark ? 'bg-white/5' : 'bg-black/[0.02]'}`}>
                        ...
                        >
                          {podcastState === 'playing' ? <Pause className="w-6 h-6" /> : <Play className="w-6 h-6" />}
                        </button>
                        <button
                          onClick={handleNext}
