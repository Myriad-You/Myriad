...
export default function Library() {
  ...
  const navItems: SecondaryNavItem[] = useMemo(() => [
    { id: 'all', icon: FilterIcons.all, label: t.nav.all, title: t.nav.all, ariaLabel: t.nav.showAll },
    { id: 'game', icon: FilterIcons.game, label: t.nav.game, title: t.nav.game, ariaLabel: t.nav.showGame },
    { id: 'video', icon: FilterIcons.video, label: t.nav.video, title: t.nav.video, ariaLabel: t.nav.showVideo },
