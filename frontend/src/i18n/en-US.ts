...
export const enUS: TranslationKeys = {
  ...
  config: {
    ...
    agentLifeNeedsLite:
      'Enable the Lite tier above first — every line it speaks runs through Lite.',
    agentLifeNeedsPro:
      'Enable the Pro tier above first — persona setup and this switch require Pro.',
    agentLifeNeedsLiteAndPro:
      'Enable the Lite and Pro tiers above first.',
    ...
    imageProviderBadgeImageApi: 'Image API',
    ...
    aiVendorLabel: 'Provider to configure',
    ...
    speechReuseTextCredentials: 'Reuse text-model credentials',
    speechReuseTextCredentialsDesc:
      'Use the standard-tier OpenAI / OpenRouter key and base URL',
    ...
    speechKeyFallbackHint: 'Optional — leave empty to reuse the text-model key above',
  ...
  life: {
    onboarding: {
      ...
      step1Lead: 'Distilled from platform reports to shape personality.',
      step2Title: 'Name',
      step2Lead: 'Set the name and gender presentation.',
      ...
      nameLabel: 'Name',
      nameHint: 'Leave blank to stay Arael. Shuffle uses Pro and the tags above.',
