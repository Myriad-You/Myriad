...
export const enUS: TranslationKeys = {
  ...
  config: {
    ...
    agentOptions: 'Agent',
    agentOptionsDesc: 'Persona, speaking, QQ / Telegram bots, scheduled tasks, skills, and memories.',
    ...
    qqBotPhaseOffline: 'Offline',
    qqBotPhaseConnecting: 'Connecting',
    qqBotPhaseOnline: 'Online',
    qqBotPhaseRejected: 'Credentials rejected',
    qqBotPhaseReconnecting: 'Reconnecting',
    qqBotTest: 'Test saved credentials',
    qqBotTesting: 'Testing…',
    qqBotTestOk: 'Saved credentials can mint a token.',
    qqBotTestFailed: 'Saved credentials could not reach the open platform.',
    telegramBotTitle: 'Telegram bot',
    telegramBotDesc: 'DM Work channel. Turn on and save the BotFather token to start long polling.',
    telegramBotToken: 'Telegram bot token',
    telegramBotHint: 'The token is write-only and reads back masked. Empty clears it. The bot stays offline if the switch is off or the token fails. Do not paste MTProto api_id / api_hash.',
    telegramBotPhaseOffline: 'Offline',
    telegramBotPhaseConnecting: 'Connecting',
    telegramBotPhaseOnline: 'Online',
    telegramBotPhaseRejected: 'Credentials rejected',
    telegramBotPhaseReconnecting: 'Reconnecting',
    telegramBotTest: 'Test saved credentials',
    telegramBotTesting: 'Testing…',
    telegramBotTestOk: 'Saved token can reach Bot API.',
    telegramBotTestFailed: 'Saved token could not reach Telegram.',
    qqBotCredentialLabel: 'Credentials',
    qqBotReceiveLabel: 'Messaging',
    qqBotIdentityLabel: 'Bot',
    qqBotCredentialUntested: 'Saved credentials have not been tested yet',
    qqBotLastInbound: 'Last inbound {time}',
    qqBotLastInboundNone: 'No inbound message yet',
    qqBotOpenHint: 'Search for the site bot in QQ and open the private chat.',
    telegramBotCredentialLabel: 'Credentials',
    telegramBotReceiveLabel: 'Messaging',
    telegramBotIdentityLabel: 'Bot',
    telegramBotCredentialUntested: 'Saved token has not been tested yet',
    telegramBotLastInbound: 'Last inbound {time}',
    telegramBotLastInboundNone: 'No inbound message yet',
    telegramBotOpen: 'Open Telegram',
    telegramBotIdentityName: '{name} (@{username})',
    telegramBotIdentityNameOnly: '{name}',
    discordBotTitle: 'Discord bot',
    discordBotDesc:
      'Private-chat work channel. Turn on, paste the Developer Portal bot token, and the worker connects to the Gateway for DMs.',
    discordBotToken: 'Discord bot token',
    discordBotHint:
      'The token is write-only; reads come back masked. Empty clears it. Off or a bad token keeps the bot offline. Do not paste the data-platform OAuth access token.',
    discordBotPhaseOffline: 'Offline',
    discordBotPhaseConnecting: 'Connecting',
    discordBotPhaseOnline: 'Online',
    discordBotPhaseRejected: 'Invalid credentials',
    discordBotPhaseReconnecting: 'Reconnecting',
    discordBotTest: 'Test saved credentials',
    discordBotTesting: 'Testing…',
    discordBotTestOk: 'Saved token reached the Discord API.',
    discordBotTestFailed: 'Saved token could not reach Discord.',
    discordBotCredentialLabel: 'Credentials',
    discordBotReceiveLabel: 'Messaging',
    discordBotIdentityLabel: 'Bot',
    discordBotCredentialUntested: 'Saved token has not been tested yet',
    discordBotLastInbound: 'Last inbound {time}',
    discordBotLastInboundNone: 'No inbound message yet',
    discordBotOpen: 'Open Discord',
    discordBotIdentityName: '{name} (@{username})',
    discordBotIdentityNameOnly: '{name}',
    feishuBotTitle: 'Feishu bot',
    feishuBotDesc:
      'Private-chat work channel. Turn on, paste the internal-app AppID / AppSecret, and the worker opens a long connection.',
    feishuBotAppId: 'Feishu bot AppID',
    feishuBotAppSecret: 'Feishu bot AppSecret',
    feishuBotHint:
      'The secret is write-only; reads come back masked. Empty clears it. Off or a bad credential keeps the bot offline.',
    feishuBotPhaseOffline: 'Offline',
    feishuBotPhaseConnecting: 'Connecting',
    feishuBotPhaseOnline: 'Online',
    feishuBotPhaseRejected: 'Invalid credentials',
    feishuBotPhaseReconnecting: 'Reconnecting',
    feishuBotTest: 'Test saved credentials',
    feishuBotTesting: 'Testing…',
    feishuBotTestOk: 'Saved credentials minted a tenant token.',
    feishuBotTestFailed: 'Saved credentials could not reach Feishu Open Platform.',
    feishuBotCredentialLabel: 'Credentials',
    feishuBotReceiveLabel: 'Messaging',
    feishuBotIdentityLabel: 'Bot',
    feishuBotCredentialUntested: 'Saved credentials have not been tested yet',
    feishuBotLastInbound: 'Last inbound {time}',
    feishuBotLastInboundNone: 'No inbound message yet',
    feishuBotOpenHint: 'Search for the site bot in Feishu and open the private chat.',
    channelWorkHint:
      'After pairing, send a request. Reply yes/no or an option number. Send “停止”, “新对话”, or “当前任务”. If a web page is required, the bot points at that task.',
  ...
  agentPersona: {
    onboarding: {
      ...
      importPortraitReplace: 'Replace',
      importEnter: 'I already have one',
      choiceTitle: 'Start',
      choiceLead: 'Two ways in. You can come back and switch.',
      choiceIntroTitle: 'Generate a persona and portrait from your reports',
      choiceIntroSub: 'Or paste a persona and upload a portrait.',
      choiceShort: 'Start',
      choiceGuidedTitle: 'Make one',
      choiceGuidedDetail: 'Generate a persona and portrait from your reports.',
      choiceGuidedMeta: '5 steps',
      choiceImportTitle: 'I already have one',
      choiceImportDetail: 'Paste a persona and upload a portrait.',
      choiceImportMeta: 'One page',
      importShort: 'Import',
      importTitle: 'Import',
      importLead:
      ...
      portraitFinish: 'Next: make her move',
    },
  },
  ...
  userModal: {
    ...
    telegramPairingTitle: 'Telegram Work channel',
    telegramPairingHint:
      'Generate a one-time code and send it to the site bot in a private chat. This is not Telegram sign-in.',
    telegramPairingLoadFailed: 'Could not load Telegram pairing.',
    telegramPairingIssueFailed: 'Could not generate a pairing code.',
    telegramPairingCopyFailed: 'Could not copy the pairing code.',
    telegramPairingGenerateHint: 'Not paired yet. Generate a code and send it to the bot.',
    telegramPairingSendCode: 'Send this code to the bot in a private chat.',
    telegramGenerateCode: 'Generate code',
    telegramRefreshCode: 'Regenerate',
    telegramCopyCode: 'Copy',
    telegramPaired: 'Paired',
    telegramNotPaired: 'Not paired',
    telegramUnpair: 'Unpair',
    telegramUnpairConfirm:
      'This Telegram account will no longer be able to drive your Agent. Unpair?',
    telegramUnpairFailed: 'Could not unpair Telegram.',
    discordPairingTitle: 'Discord work channel',
    discordPairingHint:
      'Generate a one-time pairing code and send it to the site bot in a DM. This is not Discord login.',
    discordPairingLoadFailed: 'Could not load Discord pairing status.',
    discordPairingIssueFailed: 'Could not generate a pairing code.',
    discordPairingCopyFailed: 'Could not copy the pairing code.',
    discordPairingGenerateHint: 'Not paired yet. Generate a code and send it to the bot.',
    discordPairingSendCode: 'Send this code to the bot in a private chat.',
    discordGenerateCode: 'Generate code',
    discordRefreshCode: 'Regenerate',
    discordCopyCode: 'Copy',
    discordPaired: 'Paired',
    discordNotPaired: 'Not paired',
    discordUnpair: 'Unpair',
    discordUnpairConfirm:
      'This Discord account will no longer be able to drive your Agent. Unpair?',
    discordUnpairFailed: 'Could not unpair Discord.',
    feishuPairingTitle: 'Feishu work channel',
    feishuPairingHint:
      'Generate a one-time pairing code and send it to the site bot in a private chat. This is not Feishu login.',
    feishuPairingLoadFailed: 'Could not load Feishu pairing status.',
    feishuPairingIssueFailed: 'Could not generate a pairing code.',
    feishuPairingCopyFailed: 'Could not copy the pairing code.',
    feishuPairingGenerateHint: 'Not paired yet. Generate a code and send it to the bot.',
    feishuPairingSendCode: 'Send this code to the bot in a private chat.',
    feishuGenerateCode: 'Generate code',
    feishuRefreshCode: 'Regenerate',
    feishuCopyCode: 'Copy',
    feishuPaired: 'Paired',
    feishuNotPaired: 'Not paired',
    feishuUnpair: 'Unpair',
    feishuUnpairConfirm:
      'This Feishu account will no longer be able to drive your Agent. Unpair?',
    feishuUnpairFailed: 'Could not unpair Feishu.',
    pairingExpiresAt: 'Valid until {time}',
    pairingExpired: 'This pairing code expired. Generate a new one.',
    pairingOpenBot: 'Open bot',
    pairingWaitingReceive: 'If messaging is still down, the bot may not receive the code.',
