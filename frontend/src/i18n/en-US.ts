...
export const enUS: TranslationKeys = {
  ...
  companion: {
    ...
    visualRequirements: 'Portrait refinements',
    ...
    anime25dInspectLayers: 'Layers',
    anime25dInspectStrands: 'Hair strands / layers',
    anime25dInspectEyes: 'Open / closed eyes',
    anime25dInspectMouth: 'Open / closed mouth',
    anime25dInspectCanvas: 'Canvas',
    ...
    motionSeeThroughTokenDescription:
      'Enter a token with Read access. This write-only credential is used by the backend only for 24yearsold/see-through-demo and is never returned to the browser or embedded in character assets.',
    motionSeeThroughTokenMissing:
      'Not configured. Add an hf_… token to use remote ZeroGPU.',
  ...
  life: {
    onboarding: {
      ...
      visualGroupCharacter: 'Character',
      visualGroupOutfit: 'Outfit',
