...
export const enUS: TranslationKeys = {
  ...
  config: {
    ...
    aiProvidersQuickAccess: 'Quick access',
    aiProvidersQuickAccessDesc: 'Providers · keys · docs',
  ...
  life: {
    onboarding: {
      ...
      step1Lead:
        'Picked from your platform reports, used only to grow personality.',
      step2Title: 'Give it a name',
      step2Lead: 'Everyone talks to this same person. Leave blank to stay Arael.',
      step3Title: 'Confirm personality',
      step3Lead: 'You can edit this. This is the personality everyone hears.',
      noReports: 'No reports yet. You can skip this step.',
      selectedCount: '{count} selected',
      selectNothingYet: 'None selected yet',
      skipTags: 'Skip',
      nameLabel: 'Name',
      nameHint: 'Leave blank to stay Arael.',
      namePlaceholder: 'Enter a name',
      extraPlaceholder: 'e.g. Quiet, earnest, softer with people they know',
      personaGroupCharacter: 'Personality',
      creating: 'Creating…',
  ...
  reportsPage: {
    ...
    tipPlatformCountSub: 'Click a card to enter the stage',
    tipReportReady: '{count} reports ready',
    tipReportReadySub: 'Play all, or click a card',
  ...
  arael: {
    ...
    personaLifeOff: 'Turn on Agent life in Advanced settings first.',
    statusBarTitle: 'Arael',
    statusLoading: 'Checking persona…',
    statusDisabled: 'Agent life is off',
    statusNeedLogin: 'Sign in to write the persona and hear your own events',
    statusCreateHint: 'Grow a personality from your reports',
    statusReadyHint: '{activity} · mood {mood}',
    statusIdle: 'Idle',
    statusThinking: 'Thinking',
    statusTalking: 'Talking',
    statusCreate: 'Write persona',
    statusOpen: 'Open',
    statusLogin: 'Sign in',
