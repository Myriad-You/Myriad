  ...
  life: {
    onboarding: {
      ...
      visualRequirementsHint:
        'Specify hair, eyes, outfit direction, or identity elements to preserve. These do not rewrite the confirmed personality.',
      visualRequirementsPlaceholder:
        'e.g. pink bob, violet eyes, star-track motif, airy but not childish',
