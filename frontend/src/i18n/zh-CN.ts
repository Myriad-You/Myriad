...
export const zhCN: TranslationKeys = {
  ...
  config: {
    ...
    updaterHintHealthy: '一切正常。可以随时点「检查更新」看看有没有新版本。',
    updaterHintUpdating: '更新进行中；进入维护后请在维护页查看进度。',
    updaterHintMaintenance:
      '系统处于维护状态。确认服务正常后，可在「维护与恢复」中退出。',
    updaterHintNeedsManual:
      '自动回退未完成。可在「维护与恢复」中一键回到更新前版本。',
    updaterHintOffline:
      '请检查 backend 是否配置了 MYRIAD_UPDATER_URL 和 UPDATE_TOKEN。',
    updaterHintFirstRun: '点「检查更新」获取当前通道的最新版本。',
  ...
  tapp: {
    ...
    playgroundMemoryChainEmpty: '暂无修改脉络。生成或修改后，用户与智能体的往返会出现在这里。',
