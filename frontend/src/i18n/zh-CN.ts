...
export const zhCN: TranslationKeys = {
  ...
  config: {
    ...
    volcengineArkApiKeyPlaceholder: '方舟 API Key',
    ...
    agentLifeNeedsPro: '需要先启用上面的 Pro 模型。',
    agentLifeNeedsLiteAndPro: '需要先启用上面的 Lite 模型和 Pro 模型。',
    enableProxy: '启用网络代理',
    ...
    imageProviderBadgeGptImage: 'GPT Image',
    imageProviderBadgeImageApi: '图片 API',
    imageProviderBadgeSeedream: 'Seedream',
    aiVendorsTitle: '服务商',
    aiVendorsDesc: '像登录方式一样添加源；同一家可以有多个。下面的模型和语音都从这里选。',
    aiVendorLabel: '要配置的服务商',
    aiVendorAdd: '添加服务商',
    ...
    speechReuseTextCredentials: '沿用文字模型的密钥',
    speechReuseTextCredentialsDesc: '用标准档 OpenAI / OpenRouter 的 Key 和地址，不必再抄一遍',
    speechSttModel: '转写模型',
    speechTtsModel: '播报模型',
    speechTtsVoice: '播报音色',
    speechOpenRouterTtsHint:
      'OpenRouter 目前没有官方 OpenAI 播报型号。转写可用；要官方播报请改选 OpenAI。',
    speechKeyFallbackHint: '可空：空着就用上面文字模型同一套密钥',
    // 平台配置
