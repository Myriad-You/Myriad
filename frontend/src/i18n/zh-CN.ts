...
export const zhCN: TranslationKeys = {
  ...
  config: {
    ...
    aiProvidersQuickAccess: '快捷访问',
    aiProvidersQuickAccessDesc: '服务商 · 密钥 · 文档',
    // 图片生成模型配置
    aiImageTitle: '图片生成模型',
  ...
  life: {
    onboarding: {
      ...
      step3Short: '性格',
      step1Title: '选择特征词条',
      step1Lead: '从你的平台报告里抽出几句，用来长性格。',
      step2Title: '给它一个名字',
      step2Lead: '对谁说话都是这同一个人。留空则对外仍叫 Arael。',
      step3Title: '确认性格',
      step3Lead: '可以改。这就是它对谁说话时用的性格。',
      noReports: '暂无平台报告，可跳过此步。',
      selectedCount: '已选 {count} 个',
      selectNothingYet: '尚未选择',
      skipTags: '跳过',
      nameLabel: '称呼',
      nameHint: '留空则对外仍叫 Arael。',
      namePlaceholder: '输入名称',
      extraPlaceholder: '例如：话少，认真，对熟人会软一点',
      personaGroupCharacter: '性格',
      creating: '创建中…',
  ...
  reportsPage: {
    ...
    heroStage: 'Stage',
    heroLife: 'Arael',
    tipPlatformCount: '{count} 个数据平台',
    tipPlatformCountSub: '点卡片进入舞台',
    tipReportReady: '{count} 份报告就绪',
    tipReportReadySub: '点播放全部，或点卡片进入舞台',
    tipNoReports: '还没有报告',
  ...
  arael: {
    ...
    personaLifeOff: '先在高级设置里打开 Agent 生命。',
    statusBarTitle: 'Arael',
    statusLoading: '正在确认设定…',
    statusDisabled: '生命开关是关的',
    statusNeedLogin: '登录后才能写设定、听自己的事',
    statusCreateHint: '从报告里长出一份性格',
