...
export const jaJP: TranslationKeys = {
  ...
  config: {
    ...
    feishuBotTitle: 'Feishu ボット',
    feishuBotDesc:
      '個チャットの用事チャネル。オンにして企業自建アプリの AppID / AppSecret を入れると、バックグラウンドで長接続を開きます。',
    feishuBotAppId: 'Feishu ボット AppID',
    feishuBotAppSecret: 'Feishu ボット AppSecret',
    feishuBotHint:
      '秘密は書き込み専用。読み返すとマスク。空にすると消去。オフまたは無効な資格情報ではボットはオフラインです。',
    feishuBotPhaseOffline: 'オフライン',
    feishuBotPhaseConnecting: '接続中',
    feishuBotPhaseOnline: 'オンライン',
    feishuBotPhaseRejected: '資格情報無効',
    feishuBotPhaseReconnecting: '再接続中',
    feishuBotTest: '保存済み資格情報をテスト',
    feishuBotTesting: 'テスト中…',
    feishuBotTestOk: '保存済み資格情報でテナントトークンを取得できました。',
    feishuBotTestFailed: '保存済み資格情報では Feishu 開放プラットフォームに届きませんでした。',
    feishuBotCredentialLabel: '資格情報',
    feishuBotReceiveLabel: '送受信',
    feishuBotIdentityLabel: 'ボット',
    feishuBotCredentialUntested: '保存済み資格情報はまだテストしていません',
    feishuBotLastInbound: '最後の受信 {time}',
    feishuBotLastInboundNone: 'まだ受信していません',
    feishuBotOpenHint: 'Feishu でサイトのボットを検索し、個チャットを開いてください。',
    channelWorkHint:
  ...
  userModal: {
    ...
    feishuPairingTitle: 'Feishu 用事チャネル',
    feishuPairingHint:
      '一度きりのペアリングコードを生成し、サイトのボット個チャットに送ってください。これは Feishu ログインではありません。',
    feishuPairingLoadFailed: 'Feishu の連携状態を読み込めませんでした。',
    feishuPairingIssueFailed: 'ペアリングコードを生成できませんでした。',
    feishuPairingCopyFailed: 'ペアリングコードをコピーできませんでした。',
    feishuPairingGenerateHint: 'まだ連携していません。コードを生成してボットに送ってください。',
    feishuPairingSendCode: 'このコードをボットの個チャットに送ってください。',
    feishuGenerateCode: 'コードを生成',
    feishuRefreshCode: '再生成',
    feishuCopyCode: 'コピー',
    feishuPaired: '連携済み',
    feishuNotPaired: '未連携',
    feishuUnpair: '解除',
    feishuUnpairConfirm:
      '解除すると、この Feishu アカウントはあなたの Agent を動かせなくなります。解除しますか？',
    feishuUnpairFailed: 'Feishu の連携を解除できませんでした。',
