...
export const jaJP: TranslationKeys = {
  ...
  config: {
    ...
    aiProvidersQuickAccess: 'クイックアクセス',
    aiProvidersQuickAccessDesc: '提供者 · 鍵 · ドキュメント',
    // AI画像生成設定
  ...
  life: {
    onboarding: {
      ...
      step3Short: '性格',
      step1Title: '特徴タグを選択',
      step1Lead: 'プラットフォーム報告から抜き出し、性格だけに使います。',
      step2Title: '名前をつける',
      step2Lead: '誰に話しても同じ一人です。空なら対外は Arael のまま。',
      step3Title: '性格を確認',
      step3Lead: '直せます。誰に話すときもこの性格です。',
      noReports: '報告がまだありません。このステップはスキップできます。',
      selectedCount: '{count} 件選択中',
      selectNothingYet: 'まだ選んでいません',
      skipTags: 'スキップ',
      nameLabel: '呼び名',
      nameHint: '空なら対外は Arael のまま。',
  ...
  reportsPage: {
    ...
    heroStage: 'Stage',
    heroLife: 'Arael',
    tipPlatformCount: '{count} 件のデータプラットフォーム',
    tipPlatformCountSub: 'カードを押してステージへ',
    tipReportReady: '{count} 件のレポートが準備できました',
    tipReportReadySub: '全部再生、またはカードを押す',
  ...
  arael: {
    ...
    personaLifeOff: '先に詳細設定で Agent の生命をオンにしてください。',
    statusBarTitle: 'Arael',
    statusLoading: '設定を確認中…',
    statusDisabled: '生命スイッチはオフです',
    statusNeedLogin: 'ログインすると設定を書けます',
    statusCreateHint: 'レポートから性格を育てる',
