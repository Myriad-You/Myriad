...
export const jaJP: TranslationKeys = {
  ...
  companion: {
    ...
    visualRequirements: '今回の立ち絵の追加要件',
    ...
    anime25dInspectLayers: 'レイヤー',
    anime25dInspectStrands: '髪の束 / 髪レイヤー',
    anime25dInspectEyes: '開眼 / 閉眼',
    anime25dInspectMouth: '開口 / 閉口',
    anime25dInspectCanvas: 'キャンバス',
    ...
    motionSeeThroughTokenDescription:
      'Read 権限の Token を入力します。24yearsold/see-through-demo の呼び出し時だけバックエンドが使う書き込み専用資格情報で、ブラウザーやキャラクター素材には返しません。',
    motionSeeThroughTokenMissing:
      '未設定です。リモート ZeroGPU を使うには hf_… Token を追加してください。',
