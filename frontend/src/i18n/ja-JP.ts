...
export const jaJP: TranslationKeys = {
  ...
  config: {
    ...
    guestSpeechQuota: 'ゲスト音声制限',
    guestSpeechQuotaDesc: 'ゲストセッションと Tapp ごとの日次音声利用枠',
    speechDailyTts: '日次 TTS 呼び出し回数',
    speechDailyTtsHint: 'ゲストセッションと Tapp ごとの1日あたりの音声合成回数',
    speechDailyAsr: '日次 ASR 呼び出し回数',
    speechDailyAsrHint: 'ゲストセッションと Tapp ごとの1日あたりの音声認識回数',
