...
export const jaJP: TranslationKeys = {
  ...
  config: {
    ...
    volcengineArkApiKey: '火山エンジン方舟 API キー',
    volcengineArkBaseUrl: '方舟 Base URL',
    volcengineArkApiKeyPlaceholder: '方舟 API キー',
    ...
    agentLifeNeedsLite:
      '先に上の軽量モデルを有効にしてください。口を開くときの文はすべて軽量で書きます。',
    agentLifeNeedsPro:
      '先に上の Pro モデルを有効にしてください。設定案内とこのスイッチは Pro が必要です。',
    agentLifeNeedsLiteAndPro:
      '先に上の Lite モデルと Pro モデルを有効にしてください。',
    ...
    speechReuseTextCredentials: 'テキストモデルのキーを使う',
    speechReuseTextCredentialsDesc:
      '標準枠の OpenAI / OpenRouter のキーとアドレスを流用します',
    ...
    speechKeyFallbackHint: '空欄なら上のテキストモデルと同じキーを使います',
    // プラットフォーム設定
  ...
  life: {
    onboarding: {
      ...
      step3Short: '人設',
      step1Title: '特徴タグを選択',
      step1Lead: 'プラットフォーム報告から性格を抽出します。',
      step2Title: '名前',
      step2Lead: '呼び名と性別の提示を決めます。',
      step3Title: '人設を確認',
      ...
      nameLabel: '呼び名',
      nameHint: '空なら対外は Arael のまま。シャッフルは上のタグと Pro を使います。',
